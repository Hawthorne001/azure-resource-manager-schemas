...
type CsharpGeneratorConfig = {
  namespace: string,
  enabled: boolean,
}

// Providers that have been onboarded to the C# generator instead of autorest.
const csharpGeneratorProviders: CsharpGeneratorConfig[] = [
    ...
    { namespace: 'Microsoft.AppConfiguration', enabled: true },
    { namespace: 'Microsoft.AppPlatform', enabled: false },
    { namespace: 'Microsoft.Attestation', enabled: false },
    { namespace: 'Microsoft.Authorization', enabled: false },
    { namespace: 'Microsoft.Automanage', enabled: false },
    { namespace: 'Microsoft.Automation', enabled: false },
    { namespace: 'Microsoft.AutonomousDevelopmentPlatform', enabled: false },
    { namespace: 'Microsoft.AVS', enabled: false },
    { namespace: 'Microsoft.AwsConnector', enabled: false },
    { namespace: 'Microsoft.AzureArcData', enabled: false },
    { namespace: 'Microsoft.AzureData', enabled: false },
    { namespace: 'Microsoft.AzureStack', enabled: false },
    { namespace: 'Microsoft.AzureStackHCI', enabled: false },
    { namespace: 'Microsoft.Batch', enabled: false },
    { namespace: 'Microsoft.Billing', enabled: false },
    { namespace: 'Microsoft.Blockchain', enabled: false },
    { namespace: 'Microsoft.Blueprint', enabled: false },
    { namespace: 'Microsoft.BotService', enabled: false },
    { namespace: 'Microsoft.Cache', enabled: false },
    { namespace: 'Microsoft.Capacity', enabled: false },
    { namespace: 'Microsoft.CertificateRegistration', enabled: false },
    { namespace: 'Microsoft.ChangeAnalysis', enabled: false },
    { namespace: 'Microsoft.CognitiveServices', enabled: false },
    { namespace: 'Microsoft.Commerce', enabled: false },
    { namespace: 'Microsoft.Communication', enabled: true },
    { namespace: 'Microsoft.Compute', enabled: false },
    { namespace: 'Microsoft.Confluent', enabled: false },
    { namespace: 'Microsoft.Consumption', enabled: false },
    { namespace: 'Microsoft.ContainerInstance', enabled: false },
    { namespace: 'Microsoft.ContainerRegistry', enabled: false },
    { namespace: 'Microsoft.ContainerService', enabled: false },
    { namespace: 'Microsoft.CostManagement', enabled: false },
    { namespace: 'Microsoft.CustomerLockbox', enabled: false },
    { namespace: 'Microsoft.CustomProviders', enabled: false },
    { namespace: 'Microsoft.DataBox', enabled: false },
    { namespace: 'Microsoft.DataBoxEdge', enabled: false },
    { namespace: 'Microsoft.Databricks', enabled: false },
    { namespace: 'Microsoft.DataCatalog', enabled: false },
    { namespace: 'Microsoft.Datadog', enabled: false },
    { namespace: 'Microsoft.DataFactory', enabled: false },
    { namespace: 'Microsoft.DataLakeAnalytics', enabled: false },
    { namespace: 'Microsoft.DataLakeStore', enabled: false },
    { namespace: 'Microsoft.DataMigration', enabled: false },
    { namespace: 'Microsoft.DataShare', enabled: false },
    { namespace: 'Microsoft.DBforMariaDB', enabled: false },
    ...
    { namespace: 'Microsoft.DevSpaces', enabled: false },
    { namespace: 'Microsoft.DevTestLab', enabled: false },
    { namespace: 'Microsoft.DigitalTwins', enabled: false },
    { namespace: 'Microsoft.DocumentDB', enabled: false },
    { namespace: 'Microsoft.DomainRegistration', enabled: false },
    { namespace: 'Microsoft.EdgeOrderPartner', enabled: false },
    { namespace: 'Microsoft.Elastic', enabled: false },
    { namespace: 'Microsoft.EngagementFabric', enabled: false },
    { namespace: 'Microsoft.EnterpriseKnowledgeGraph', enabled: false },
    { namespace: 'Microsoft.EventGrid', enabled: false },
    { namespace: 'Microsoft.EventHub', enabled: false },
    { namespace: 'Microsoft.Features', enabled: false },
    { namespace: 'Microsoft.GuestConfiguration', enabled: false },
    { namespace: 'Microsoft.HanaOnAzure', enabled: false },
    { namespace: 'Microsoft.HardwareSecurityModules', enabled: false },
    { namespace: 'Microsoft.HDInsight', enabled: false },
    { namespace: 'Microsoft.HealthBot', enabled: false },
    { namespace: 'Microsoft.HealthcareApis', enabled: false },
    { namespace: 'Microsoft.HybridCompute', enabled: false },
    { namespace: 'Microsoft.HybridConnectivity', enabled: false },
    { namespace: 'Microsoft.HybridData', enabled: false },
    { namespace: 'Microsoft.HybridNetwork', enabled: false },
    { namespace: 'Microsoft.ImportExport', enabled: false },
    { namespace: 'Microsoft.Insights', enabled: false },
    { namespace: 'Microsoft.Intune', enabled: false },
    { namespace: 'Microsoft.IotCentral', enabled: false },
    { namespace: 'Microsoft.IoTSecurity', enabled: false },
    { namespace: 'Microsoft.IoTSpaces', enabled: false },
    { namespace: 'Microsoft.KeyVault', enabled: false },
    { namespace: 'Microsoft.Kubernetes', enabled: true },
    { namespace: 'Microsoft.KubernetesConfiguration', enabled: false },
    { namespace: 'Microsoft.Kusto', enabled: false },
    { namespace: 'Microsoft.LabServices', enabled: false },
    { namespace: 'Microsoft.Logic', enabled: false },
    { namespace: 'Microsoft.Logz', enabled: false },
    { namespace: 'Microsoft.MachineLearning', enabled: false },
    { namespace: 'Microsoft.MachineLearningCompute', enabled: false },
    { namespace: 'Microsoft.MachineLearningExperimentation', enabled: false },
    ...
    { namespace: 'Microsoft.MixedReality', enabled: false },
    ...
    { namespace: 'Microsoft.Peering', enabled: false },
    { namespace: 'Microsoft.PolicyInsights', enabled: false },
    { namespace: 'Microsoft.Portal', enabled: false },
    { namespace: 'Microsoft.PowerBI', enabled: false },
    { namespace: 'Microsoft.PowerBIDedicated', enabled: false },
    { namespace: 'Microsoft.PowerPlatform', enabled: true },
    { namespace: 'Microsoft.ProviderHub', enabled: false },
    { namespace: 'Microsoft.Quantum', enabled: false },
    { namespace: 'Microsoft.Quota', enabled: false },
    { namespace: 'Microsoft.RecoveryServices', enabled: false },
    { namespace: 'Microsoft.RedHatOpenShift', enabled: false },
    { namespace: 'Microsoft.Relay', enabled: false },
    { namespace: 'Microsoft.ResourceGraph', enabled: false },
    { namespace: 'Microsoft.ResourceHealth', enabled: false },
    { namespace: 'Microsoft.Resources', enabled: false },
    { namespace: 'Microsoft.Scheduler', enabled: false },
    { namespace: 'Microsoft.Search', enabled: false },
    { namespace: 'Microsoft.Security', enabled: false },
    { namespace: 'Microsoft.SecurityInsights', enabled: false },
    { namespace: 'Microsoft.SerialConsole', enabled: false },
    { namespace: 'Microsoft.ServiceBus', enabled: false },
    { namespace: 'Microsoft.ServiceFabric', enabled: false },
    { namespace: 'Microsoft.ServiceFabricMesh', enabled: false },
    { namespace: 'Microsoft.ServiceLinker', enabled: false },
    { namespace: 'Microsoft.ServiceNetworking', enabled: false },
    { namespace: 'Microsoft.SignalRService', enabled: false },
    { namespace: 'Microsoft.SoftwarePlan', enabled: false },
    { namespace: 'Microsoft.Solutions', enabled: false },
    { namespace: 'Microsoft.Sql', enabled: false },
    { namespace: 'Microsoft.SqlVirtualMachine', enabled: false },
    { namespace: 'Microsoft.Storage', enabled: false },
    { namespace: 'Microsoft.StorageCache', enabled: false },
    { namespace: 'Microsoft.StoragePool', enabled: false },
    { namespace: 'Microsoft.StorageSync', enabled: false },
    { namespace: 'Microsoft.StorSimple', enabled: false },
    { namespace: 'Microsoft.StreamAnalytics', enabled: false },
    { namespace: 'Microsoft.Subscription', enabled: false },
    { namespace: 'Microsoft.Support', enabled: false },
    { namespace: 'Microsoft.Synapse', enabled: false },
    { namespace: 'Microsoft.TimeSeriesInsights', enabled: false },
    { namespace: 'Microsoft.VirtualMachineImages', enabled: false },
    { namespace: 'Microsoft.VisualStudio', enabled: false },
    { namespace: 'Microsoft.VMwareCloudSimple', enabled: false },
    { namespace: 'Microsoft.Web', enabled: false },
    { namespace: 'Microsoft.WindowsESU', enabled: false },
    { namespace: 'Microsoft.WindowsIoT', enabled: false },
    { namespace: 'Microsoft.WorkloadMonitor', enabled: false },
];
